...
- **CLAUDE.md vs FIRM_FIT.md/COLIN_V2.1 tension, never fully reconciled**: CLAUDE.md (externally edited during this session, not by me) states 0.5% risk / 92% pass / no-deadline / ~11-month median. FIRM_FIT.md's COLIN_V2.1 says 2% risk / swing-account / 318-day median. Neither of these governs the Tradeify Select day-trading plan built tonight (that has its own $-based sizing in select_pass_planner.py) — but if Colin ever asks "what's our sizing doctrine," these two docs disagree and nobody has picked a winner.
